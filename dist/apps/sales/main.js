...
const app_controller_1 = __webpack_require__(95);
const app_service_1 = __webpack_require__(96);
const proposal_module_1 = __webpack_require__(97);
const closure_module_1 = __webpack_require__(125);
const project_module_1 = __webpack_require__(129);
const dashboard_module_1 = __webpack_require__(132);
const invoice_module_1 = __webpack_require__(135);
...
const proposal_file_entity_1 = __webpack_require__(44);
const proposal_version_entity_1 = __webpack_require__(67);
const proposal_service_1 = __webpack_require__(98);
const proposal_controller_1 = __webpack_require__(110);
const proposal_report_service_1 = __webpack_require__(99);
const lead_entity_1 = __webpack_require__(39);
const lead_service_entity_1 = __webpack_require__(40);
const customer_entity_1 = __webpack_require__(36);
const customerAddress_entity_1 = __webpack_require__(37);
...
const config_module_1 = __webpack_require__(10);
const response_handler_module_1 = __webpack_require__(93);
const jwt_service_1 = __webpack_require__(116);
const authMiddleware_1 = __webpack_require__(115);
const authMiddleware_guard_1 = __webpack_require__(114);
const pdf_template_service_1 = __webpack_require__(104);
const s3_module_1 = __webpack_require__(124);
    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([
                ...
                proposal_version_entity_1.ProposalVersion,
                lead_entity_1.Lead,
...
const proposal_file_entity_1 = __webpack_require__(44);
const proposal_version_entity_1 = __webpack_require__(67);
const proposal_version_repository_1 = __webpack_require__(92);
const proposal_acceptance_entity_1 = __webpack_require__(66);
const proposal_report_service_1 = __webpack_require__(99);
const pdf_template_service_1 = __webpack_require__(104);
const s3File_service_1 = __webpack_require__(107);
const path = tslib_1.__importStar(__webpack_require__(101));
const fs = tslib_1.__importStar(__webpack_require__(102));
const serviceConstants_1 = __webpack_require__(35);
const userContants_1 = __webpack_require__(16);
//import * as os from 'os';
let ProposalService = class ProposalService {
    constructor(proposalRepo, leadRepo, proposalFileRepo, proposalVersionRepo, dataSource, proposalReportService, pdfTemplateService, s3Service) {
        this.proposalRepo = proposalRepo;
        this.leadRepo = leadRepo;
        this.proposalFileRepo = proposalFileRepo;
        this.proposalVersionRepo = proposalVersionRepo;
    ...
    async getProposals(query, actor) {
        ...
        const qb = this.proposalRepo.createQueryBuilder('proposal')
            ...
            .leftJoin(proposal_acceptance_entity_1.ProposalAcceptance, 'closure', 'closure.proposalId = proposal.id')
            .where('lead.isActive = :isActive', { isActive: true })
            .andWhere('proposal.status NOT IN (:...excludedStatuses)', { excludedStatuses: [proposal_entity_1.PROPOSAL_STATUS.DROPPED, proposal_entity_1.PROPOSAL_STATUS.REVISED] })
    ...
    async rollbackProposal(id, versionId, actor, query) {
        await this.dataSource.transaction(async (manager) => {
            // 1. Fetch the target version to restore from
            const targetVersion = await manager.findOne(proposal_version_entity_1.ProposalVersion, {
                where: { id: versionId, proposalId: id }
            });
            if (!targetVersion)
                throw new common_1.NotFoundException('Proposal version not found');
            // 2. Fetch current proposal WITH relations for snapshotting
            const currentSnapshotProposal = await manager.findOne(proposal_entity_1.Proposal, {
                where: { id },
            ...
            const archiveVersion = manager.create(proposal_version_entity_1.ProposalVersion, {
                proposalId: currentSnapshotProposal.id,
                version: currentSnapshotProposal.version,
                snapshotData: snapshotData
            });
            await manager.save(proposal_version_entity_1.ProposalVersion, archiveVersion);
            ...
            const proposalToUpdate = await manager.findOne(proposal_entity_1.Proposal, { where: { id } });
            if (!proposalToUpdate)
                throw new common_1.NotFoundException('Proposal not found for update');
            ...
            const { items: _items, paymentTerms: _paymentTerms, files: _files, lead: _lead, id: _oldId, createdAt: _createdAt, updatedAt: _updatedAt, version: _version, ...scalarData } = data;
            Object.assign(proposalToUpdate, {
                ...scalarData,
                version: newVersionNumber,
                updatedAt: new Date(),
            });
            await manager.save(proposal_entity_1.Proposal, proposalToUpdate);
            // 5. Restore Items and Payment Terms from snapshot
            if (_items && _items.length > 0) {
                for (const itemData of _items) {
                    const { paymentTerms: itemPaymentTerms, id: _oldItemId, proposal: _proposal, ...itemScalar } = itemData;
                    const newItem = manager.create(proposal_item_entity_1.ProposalItem, {
                        ...itemScalar,
                        proposalId: id
                    });
                    const savedItem = await manager.save(proposal_item_entity_1.ProposalItem, newItem);
                    if (itemPaymentTerms && itemPaymentTerms.length > 0) {
                        const newTerms = itemPaymentTerms.map((pt) => {
                            const { id: _oldPtId, proposal: _ptProp, proposalItem: _ptItem, ...ptScalar } = pt;
                            return manager.create(proposal_payment_term_entity_1.ProposalPaymentTerm, {
                                ...ptScalar,
                                proposalId: id,
                                proposalItemId: savedItem.id
                            });
                        });
                        await manager.save(proposal_payment_term_entity_1.ProposalPaymentTerm, newTerms);
                    }
                }
            }
        });
    ...
    async updateProposal(id, dto) {
        return this.dataSource.transaction(async (manager) => {
            ...
            const snapshotProposal = await manager.findOne(proposal_entity_1.Proposal, {
                where: { id },
                relations: ['items', 'paymentTerms', 'files']
            });
            if (!snapshotProposal)
            ...
            const proposalVersion = manager.create(proposal_version_entity_1.ProposalVersion, {
                proposalId: snapshotProposal.id,
                version: snapshotProposal.version,
                snapshotData: snapshotData
            });
            await manager.save(proposal_version_entity_1.ProposalVersion, proposalVersion);
            ...
            const existingProposal = await manager.findOne(proposal_entity_1.Proposal, { where: { id } });
            ...
            if (itemDtos) {
                ...
                await manager.delete(proposal_payment_term_entity_1.ProposalPaymentTerm, { proposalId: existingProposal.id });
                await manager.delete(proposal_item_entity_1.ProposalItem, { proposalId: existingProposal.id });
                let subTotal = 0;
                let totalDiscount = 0;
                let totalTaxAmount = 0;
                const savedItems = [];
                ...
                if (savedItems.length > 0)
                    existingProposal.currency = savedItems[0].currency;
            ...
            await manager.save(proposal_entity_1.Proposal, existingProposal);
...
exports.ProposalService = ProposalService = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _a : Object, typeof (_b = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _b : Object, typeof (_c = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _c : Object, typeof (_d = typeof proposal_version_repository_1.ProposalVersionRepository !== "undefined" && proposal_version_repository_1.ProposalVersionRepository) === "function" ? _d : Object, typeof (_e = typeof typeorm_2.DataSource !== "undefined" && typeorm_2.DataSource) === "function" ? _e : Object, typeof (_f = typeof proposal_report_service_1.ProposalReportService !== "undefined" && proposal_report_service_1.ProposalReportService) === "function" ? _f : Object, typeof (_g = typeof pdf_template_service_1.PdfTemplateService !== "undefined" && pdf_template_service_1.PdfTemplateService) === "function" ? _g : Object, typeof (_h = typeof s3File_service_1.S3FileService !== "undefined" && s3File_service_1.S3FileService) === "function" ? _h : Object])
], ProposalService);
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const pdfkit_1 = tslib_1.__importDefault(__webpack_require__(100));
const path = tslib_1.__importStar(__webpack_require__(101));
const fs = tslib_1.__importStar(__webpack_require__(102));
const axios_1 = tslib_1.__importDefault(__webpack_require__(103));
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const pdf_lib_1 = __webpack_require__(105);
const fs = tslib_1.__importStar(__webpack_require__(102));
const path = tslib_1.__importStar(__webpack_require__(101));
const pizzip_1 = tslib_1.__importDefault(__webpack_require__(106));
...
const common_1 = __webpack_require__(2);
const config_service_1 = __webpack_require__(6);
const aws_sdk_1 = __webpack_require__(108);
const node_crypto_1 = __webpack_require__(109);
...
const common_1 = __webpack_require__(2);
const proposal_service_1 = __webpack_require__(98);
const create_proposal_dto_1 = __webpack_require__(111);
const express_1 = __webpack_require__(113);
const response_handler_service_1 = __webpack_require__(94);
const authMiddleware_guard_1 = __webpack_require__(114);
const platform_express_1 = __webpack_require__(121);
const custom_interface_1 = __webpack_require__(122);
const proposal_entity_1 = __webpack_require__(41);
const s3File_service_1 = __webpack_require__(107);
...
let ProposalController = class ProposalController {
    ...
    async findAll(req, res, leadId, assignmentGroupId, status, search, page, limit) {
        try {
    ...
    async getVersions(res, proposalId, leadId, assignmentGroupId, status, search, page, limit) {
        try {
    ...
    async rollback(req, res, id, versionId, query) {
        try {
...
tslib_1.__decorate([
    ...
    tslib_1.__param(3, (0, common_1.Query)('assignmentGroupId')),
    ...
    tslib_1.__param(7, (0, common_1.Query)('limit')),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_t = typeof authenticated_request_interface_1.AuthenticatedRequest !== "undefined" && authenticated_request_interface_1.AuthenticatedRequest) === "function" ? _t : Object, typeof (_u = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _u : Object, String, String, typeof (_v = typeof proposal_entity_1.PROPOSAL_STATUS !== "undefined" && proposal_entity_1.PROPOSAL_STATUS) === "function" ? _v : Object, String, Number, Number]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_w = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _w : Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    (0, common_1.UseGuards)(authMiddleware_guard_1.TokenValidationGuard),
    tslib_1.__param(0, (0, common_1.Res)()),
    tslib_1.__param(1, (0, common_1.Query)('proposalId')),
    tslib_1.__param(2, (0, common_1.Query)('leadId')),
    tslib_1.__param(3, (0, common_1.Query)('assignmentGroupId')),
    tslib_1.__param(4, (0, common_1.Query)('status')),
    tslib_1.__param(5, (0, common_1.Query)('search')),
    ...
    tslib_1.__param(7, (0, common_1.Query)('limit')),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_x = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _x : Object, Number, String, String, typeof (_y = typeof proposal_entity_1.PROPOSAL_STATUS !== "undefined" && proposal_entity_1.PROPOSAL_STATUS) === "function" ? _y : Object, String, Number, Number]),
    tslib_1.__metadata("design:returntype", Promise)
], ProposalController.prototype, "getVersions", null);
tslib_1.__decorate([
    ...
    tslib_1.__param(3, (0, common_1.Param)('versionId', common_1.ParseIntPipe)),
    tslib_1.__param(4, (0, common_1.Query)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_z = typeof authenticated_request_interface_1.AuthenticatedRequest !== "undefined" && authenticated_request_interface_1.AuthenticatedRequest) === "function" ? _z : Object, typeof (_0 = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _0 : Object, Number, Number, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], ProposalController.prototype, "rollback", null);
tslib_1.__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(authMiddleware_guard_1.TokenValidationGuard),
    tslib_1.__param(0, (0, common_1.Res)()),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_1 = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _1 : Object, Number]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_2 = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _2 : Object, Number]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_3 = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _3 : Object, Number]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_5 = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _5 : Object, Number, typeof (_6 = typeof create_proposal_dto_1.UpdateProposalStatusDto !== "undefined" && create_proposal_dto_1.UpdateProposalStatusDto) === "function" ? _6 : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, (0, common_1.Body)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_7 = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _7 : Object, Number, typeof (_8 = typeof create_proposal_dto_1.UpdateProposalDto !== "undefined" && create_proposal_dto_1.UpdateProposalDto) === "function" ? _8 : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_9 = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _9 : Object, Number]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_10 = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _10 : Object, Number]),
    tslib_1.__metadata("design:returntype", Promise)
...
const class_transformer_1 = __webpack_require__(18);
const class_validator_1 = __webpack_require__(17);
const mapped_types_1 = __webpack_require__(112);
const proposal_entity_1 = __webpack_require__(41);
...
const commonConstants_1 = __webpack_require__(19);
const jwt_service_1 = __webpack_require__(116);
const src_1 = __webpack_require__(118);
const response_handler_service_1 = __webpack_require__(94);
const userContants_1 = __webpack_require__(16);
const config_service_1 = __webpack_require__(6);
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(2);
const jwt = tslib_1.__importStar(__webpack_require__(117));
const config_service_1 = __webpack_require__(6);
const commonConstants_1 = __webpack_require__(19);
...
const project_entity_1 = __webpack_require__(68);
const department_entity_1 = __webpack_require__(22);
const closure_service_1 = __webpack_require__(126);
const closure_controller_1 = __webpack_require__(127);
const database_module_1 = __webpack_require__(5);
const config_module_1 = __webpack_require__(10);
const response_handler_module_1 = __webpack_require__(93);
const jwt_service_1 = __webpack_require__(116);
...
const common_1 = __webpack_require__(2);
const closure_service_1 = __webpack_require__(126);
const create_closure_dto_1 = __webpack_require__(128);
const express_1 = __webpack_require__(113);
const response_handler_service_1 = __webpack_require__(94);
const authMiddleware_guard_1 = __webpack_require__(114);
const platform_express_1 = __webpack_require__(121);
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(11);
const project_service_1 = __webpack_require__(130);
const project_controller_1 = __webpack_require__(131);
const project_entity_1 = __webpack_require__(68);
const user_entity_1 = __webpack_require__(13);
const team_entity_1 = __webpack_require__(26);
const config_module_1 = __webpack_require__(10);
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(11);
const dashboard_controller_1 = __webpack_require__(133);
const dashboard_service_1 = __webpack_require__(134);
const lead_entity_1 = __webpack_require__(39);
const proposal_acceptance_entity_1 = __webpack_require__(66);
const project_entity_1 = __webpack_require__(68);
const proposal_entity_1 = __webpack_require__(41);
...
let DashboardService = class DashboardService {
    ...
    async getDashboardCounts(actor) {
      ...
      )`, { droppedProposalStatus: proposal_entity_1.PROPOSAL_STATUS.DROPPED });
        if (!isAdmin && actor?.id) {
        ...
        const proposalListQuery = this.proposalRepo.createQueryBuilder('p')
            ...
            .leftJoin(proposal_acceptance_entity_1.ProposalAcceptance, 'closure', 'closure.proposalId = p.id')
            .where('lead.isActive = :isActive', { isActive: true })
            .andWhere('p.status NOT IN (:...excludedStatuses)', { excludedStatuses: [proposal_entity_1.PROPOSAL_STATUS.DROPPED, proposal_entity_1.PROPOSAL_STATUS.REVISED] })
            .andWhere('closure.id IS NULL');
        if (!isAdmin && actor?.id) {
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(11);
const invoice_controller_1 = __webpack_require__(136);
const invoice_service_1 = __webpack_require__(137);
const invoice_report_service_1 = __webpack_require__(138);
const invoice_entity_1 = __webpack_require__(69);
const invoice_item_entity_1 = __webpack_require__(70);
const payment_record_entity_1 = __webpack_require__(71);
const proposal_acceptance_entity_1 = __webpack_require__(66);
...
const response_handler_service_1 = __webpack_require__(94);
const authMiddleware_guard_1 = __webpack_require__(114);
const invoice_dto_1 = __webpack_require__(139);
const salesConstants_1 = __webpack_require__(48);
...
const config_service_1 = __webpack_require__(6);
const express = tslib_1.__importStar(__webpack_require__(113));
