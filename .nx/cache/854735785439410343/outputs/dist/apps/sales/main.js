...
let DashboardService = class DashboardService {
    ...
    async getDashboardCounts() {
        ...
        const dropClients = await this.leadRepo.count({
            where: { status: salesConstants_1.LEAD_STATUS.LOST, isDraft: false },
        });
        ...
        const distributedCount = await this.leadServiceRepo.count({
            where: { department: (0, typeorm_2.Not)((0, typeorm_2.IsNull)()) }, // Count services assigned to a department
        });
