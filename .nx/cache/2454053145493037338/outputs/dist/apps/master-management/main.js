        ...
        try {
            ...
            const query = this.leadRepository.createQueryBuilder('lead')
                ...
                qb.where('lead.status = :leadLostStatus', { leadLostStatus: salesConstants_2.LEAD_STATUS.LOST })
                    .orWhere('proposals.status = :proposalDroppedStatus', { proposalDroppedStatus: salesConstants_1.PROPOSAL_STATUS.DROPPED })
    ...
    async rollbackLead(id, payload, actor) {
        return await this.dataSource.transaction(async (manager) => {
            ...
            await manager.getRepository(proposal_entity_1.Proposal).update({
                ...
                status: salesConstants_1.PROPOSAL_STATUS.DRAFT,
                notes: payload.notes
...
exports.B2BPartnerModule = B2BPartnerModule = tslib_1.__decorate([
    (0, common_1.Module)({
        ...
        providers: [b2b_partner_service_1.B2BPartnerService, response_handler_service_1.ResponseHandlerService],
