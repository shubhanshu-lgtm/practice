...
const lead_module_1 = __webpack_require__(85);
const proposal_module_1 = __webpack_require__(103);
const closure_module_1 = __webpack_require__(107);
const project_module_1 = __webpack_require__(111);
...
const customerContact_entity_1 = __webpack_require__(36);
const service_master_entity_1 = __webpack_require__(33);
const lead_service_1 = __webpack_require__(86);
const lead_controller_1 = __webpack_require__(87);
const config_module_1 = __webpack_require__(10);
const database_module_1 = __webpack_require__(5);
const response_handler_module_1 = __webpack_require__(81);
    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([
                ...
                service_master_entity_1.ServiceMaster
            ])
        ],
        providers: [lead_service_1.LeadManagementService],
        controllers: [lead_controller_1.LeadController],
        exports: [lead_service_1.LeadManagementService]
    })
], LeadModule);
...
var _a, _b, _c, _d, _e, _f, _g;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LeadManagementService = void 0;
const tslib_1 = __webpack_require__(4);
const common_1 = __webpack_require__(1);
const typeorm_1 = __webpack_require__(11);
const typeorm_2 = __webpack_require__(14);
...
const customerContact_entity_1 = __webpack_require__(36);
const service_master_entity_1 = __webpack_require__(33);
let LeadManagementService = class LeadManagementService {
    constructor(leadRepo, leadServiceRepo, customerRepo, addressRepo, contactRepo, serviceMasterRepo, dataSource) {
    ...
    async generateEnquiryId() {
        ...
        const count = await this.leadRepo.count({ where: { createdAt: (0, typeorm_2.Between)(start, end) } });
        const sequence = String(count + 1).padStart(2, '0');
    ...
    generateCustomerId(customerName, country) {
    ...
    async createLead(dto) {
        return this.dataSource.transaction(async (manager) => {
            ...
            // 2. Addresses
            if (dto.addresses && dto.addresses.length > 0) {
                const addresses = dto.addresses.map(addr => manager.create(customerAddress_entity_1.CustomerAddress, { ...addr, customer }));
                await manager.save(customerAddress_entity_1.CustomerAddress, addresses);
            }
            // 3. Contacts
            if (dto.contacts && dto.contacts.length > 0) {
                const contacts = dto.contacts.map(ct => manager.create(customerContact_entity_1.CustomerContact, { ...ct, customer }));
                await manager.save(customerContact_entity_1.CustomerContact, contacts);
            }
            // 4. Lead
            const enquiryId = await this.generateEnquiryId();
            ...
            const savedLead = await manager.save(lead_entity_1.Lead, lead);
            // 5. Services
            if (dto.serviceIds && dto.serviceIds.length > 0) {
                const services = await this.serviceMasterRepo.findBy({ id: (0, typeorm_2.In)(dto.serviceIds) }); // In import needed
                const leadServices = services.map(svc => manager.create(lead_service_entity_1.LeadService, {
                    lead: savedLead,
                    service: svc
                }));
    ...
    async updateLeadServiceDetails(leadServiceId, details) {
...
exports.LeadManagementService = LeadManagementService;
exports.LeadManagementService = LeadManagementService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__param(0, (0, typeorm_1.InjectRepository)(lead_entity_1.Lead)),
    tslib_1.__param(1, (0, typeorm_1.InjectRepository)(lead_service_entity_1.LeadService)),
    tslib_1.__param(2, (0, typeorm_1.InjectRepository)(customer_entity_1.Customer)),
    tslib_1.__param(3, (0, typeorm_1.InjectRepository)(customerAddress_entity_1.CustomerAddress)),
    tslib_1.__param(4, (0, typeorm_1.InjectRepository)(customerContact_entity_1.CustomerContact)),
...
const lead_service_1 = __webpack_require__(86);
const lead_dto_1 = __webpack_require__(89);
const update_lead_service_dto_1 = __webpack_require__(91);
const response_handler_service_1 = __webpack_require__(82);
const src_1 = __webpack_require__(92);
const permission_access_guard_1 = __webpack_require__(100);
const permission_access_decorator_1 = __webpack_require__(101);
const moduleConstants_1 = __webpack_require__(102);
const permissionManagerConstants_1 = __webpack_require__(20);
let LeadController = class LeadController {
    ...
    async updateServiceDetails(res, id, body) {
        try {
            const result = await this.leadService.updateLeadServiceDetails(id.toString(), body);
            return this.responseHandler.sendSuccessResponse(res, { message: 'Lead service updated successfully', data: result });
        }
        catch (error) {
            return this.responseHandler.sendErrorResponse(res, error);
        }
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_c = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _c : Object, typeof (_d = typeof lead_dto_1.CreateLeadDto !== "undefined" && lead_dto_1.CreateLeadDto) === "function" ? _d : Object]),
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_f = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _f : Object, String, typeof (_g = typeof update_lead_service_dto_1.UpdateLeadServiceDetailsDto !== "undefined" && update_lead_service_dto_1.UpdateLeadServiceDetailsDto) === "function" ? _g : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], LeadController.prototype, "updateServiceDetails", null);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof userContants_1.ADDRESS_TYPE !== "undefined" && userContants_1.ADDRESS_TYPE) === "function" ? _a : Object)
...
tslib_1.__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(salesConstants_1.LEAD_SOURCE),
    tslib_1.__metadata("design:type", typeof (_d = typeof salesConstants_1.LEAD_SOURCE !== "undefined" && salesConstants_1.LEAD_SOURCE) === "function" ? _d : Object)
...
tslib_1.__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(salesConstants_1.LEAD_STATUS),
    tslib_1.__metadata("design:type", typeof (_e = typeof salesConstants_1.LEAD_STATUS !== "undefined" && salesConstants_1.LEAD_STATUS) === "function" ? _e : Object)
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UpdateLeadServiceDetailsDto = void 0;
const tslib_1 = __webpack_require__(4);
const class_validator_1 = __webpack_require__(17);
class UpdateLeadServiceDetailsDto {
}
exports.UpdateLeadServiceDetailsDto = UpdateLeadServiceDetailsDto;
tslib_1.__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsObject)(),
    tslib_1.__metadata("design:type", typeof (_a = typeof Record !== "undefined" && Record) === "function" ? _a : Object)
], UpdateLeadServiceDetailsDto.prototype, "deliverables", void 0);
tslib_1.__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], UpdateLeadServiceDetailsDto.prototype, "timeline", void 0);
tslib_1.__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], UpdateLeadServiceDetailsDto.prototype, "accreditationBody", void 0);
tslib_1.__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    tslib_1.__metadata("design:type", Number)
], UpdateLeadServiceDetailsDto.prototype, "fees", void 0);
...
const tslib_1 = __webpack_require__(4);
const common_1 = __webpack_require__(1);
const jwt = tslib_1.__importStar(__webpack_require__(95));
const typeorm_1 = __webpack_require__(11);
const typeorm_2 = __webpack_require__(14);
const src_1 = __webpack_require__(96);
const config_service_1 = __webpack_require__(6);
...
const proposal_item_entity_1 = __webpack_require__(40);
const proposal_payment_term_entity_1 = __webpack_require__(41);
const proposal_service_1 = __webpack_require__(104);
const proposal_controller_1 = __webpack_require__(105);
const lead_entity_1 = __webpack_require__(37);
const lead_service_entity_1 = __webpack_require__(38);
const proposal_item_repository_1 = __webpack_require__(77);
const proposal_payment_term_repository_1 = __webpack_require__(78);
const config_module_1 = __webpack_require__(10);
const database_module_1 = __webpack_require__(5);
const response_handler_module_1 = __webpack_require__(81);
...
const common_1 = __webpack_require__(1);
const proposal_service_1 = __webpack_require__(104);
const create_proposal_dto_1 = __webpack_require__(106);
...
const proposal_entity_1 = __webpack_require__(39);
const lead_entity_1 = __webpack_require__(37);
const closure_service_1 = __webpack_require__(108);
const closure_controller_1 = __webpack_require__(109);
const project_entity_1 = __webpack_require__(63);
...
const common_1 = __webpack_require__(1);
const closure_service_1 = __webpack_require__(108);
const create_closure_dto_1 = __webpack_require__(110);
...
const common_1 = __webpack_require__(1);
const typeorm_1 = __webpack_require__(11);
const project_service_1 = __webpack_require__(112);
const project_controller_1 = __webpack_require__(113);
const project_entity_1 = __webpack_require__(63);
const user_entity_1 = __webpack_require__(13);
const team_entity_1 = __webpack_require__(26);
const config_module_1 = __webpack_require__(10);
