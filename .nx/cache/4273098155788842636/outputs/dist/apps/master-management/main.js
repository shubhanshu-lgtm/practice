        ...
        if (!user) {
            if (email.endsWith('@intercert.com')) {
                ...
                user = await this.userRepository.save({
                    ...
                    password: hashedPassword,
                    roleName: userContants_1.USER_GROUP.SUPER_ADMIN,
                    user_group: userContants_1.USER_GROUP.SUPER_ADMIN,
                    status: userContants_1.USER_ACCOUNT_STATUS.ACTIVE,
                    verifyStatus: userContants_1.USER_VERIFY_STATUS.VERIFIED,
                    loginSource: userContants_1.USER_LOGIN_SOURCE.GOOGLE,
                    avatar: picture
                });
            }
            else {
...
exports.UserManagementModule = UserManagementModule = tslib_1.__decorate([
    (0, common_1.Module)({
        imports: [
            ...
            config_module_1.ConfigModule,
            s3_module_1.S3Module,
            response_handler_module_1.ResponseHandlerModule, typeorm_1.TypeOrmModule.forFeature([src_1.User, systemModule_entity_1.SystemModule, src_1.Department, src_1.Team, src_1.LoginSession])
        ],
