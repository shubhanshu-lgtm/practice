...
const app_controller_1 = __webpack_require__(64);
const app_service_1 = __webpack_require__(65);
const config_module_1 = __webpack_require__(10);
const response_handler_module_1 = __webpack_require__(66);
const world_data_module_1 = __webpack_require__(68);
const auth_module_1 = __webpack_require__(100);
const department_module_1 = __webpack_require__(114);
const module_management_module_1 = __webpack_require__(121);
const lead_module_1 = __webpack_require__(125);
const user_management_module_1 = __webpack_require__(130);
...
const tslib_1 = __webpack_require__(4);
const common_1 = __webpack_require__(1);
const response_handler_service_1 = __webpack_require__(67);
...
const tslib_1 = __webpack_require__(4);
const common_1 = __webpack_require__(1);
const src_1 = __webpack_require__(69);
const config_module_1 = __webpack_require__(10);
const response_handler_module_1 = __webpack_require__(66);
const typeorm_1 = __webpack_require__(11);
...
exports.LeadRepository = LeadRepository = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__param(0, (0, typeorm_1.InjectRepository)(src_1.LeadEnquiry)),
    tslib_1.__param(1, (0, typeorm_1.InjectRepository)(src_1.LeadContact)),
    tslib_1.__param(2, (0, typeorm_1.InjectRepository)(src_1.LeadAddress)),
...
const userContants_1 = __webpack_require__(16);
const permissionManager_entity_1 = __webpack_require__(19);
const basicUtils_1 = __webpack_require__(77);
let UserRepositoryService = class UserRepositoryService {
    ...
    async getUserCounts(input) {
        try {
            const { groups } = input;
            const groupIN = groups.map((_, index) => `?`).join(', ');
...
const tslib_1 = __webpack_require__(4);
const mobile_1 = tslib_1.__importDefault(__webpack_require__(78));
...
const permissionManager_entity_1 = __webpack_require__(19);
const user_entity_1 = __webpack_require__(13);
let PermissionManagerService = class PermissionManagerService {
...
exports.PermissionManagerService = PermissionManagerService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
...
exports.LoginSessionService = LoginSessionService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
...
let ProposalRepository = class ProposalRepository {
    ...
    async findOne(id) {
        return this.repo.findOne({ where: { id: Number(id).toString() } });
    }
    async update(id, proposal) {
        await this.repo.update(Number(id).toString(), proposal);
    }
    async remove(id) {
        await this.repo.delete(Number(id).toString());
    }
};
...
let ProposalItemRepository = class ProposalItemRepository {
    ...
    async update(id, item) {
        await this.repo.update(Number(id).toString(), item);
    }
    async remove(id) {
        await this.repo.delete(Number(id).toString());
    }
...
const google_strategy_1 = __webpack_require__(110);
const jwt_service_1 = __webpack_require__(103);
const jwt_auth_guard_1 = __webpack_require__(112);
const response_handler_module_1 = __webpack_require__(66);
const defaultUser_service_1 = __webpack_require__(113);
const user_repository_1 = __webpack_require__(76);
const permissionManager_repository_1 = __webpack_require__(79);
let AuthModule = class AuthModule {
...
exports.AuthModule = AuthModule = tslib_1.__decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([src_1.User, src_1.LoginSession, src_1.PermissionManager]),
        ...
        providers: [
            ...
            permissionManager_repository_1.PermissionManagerService,
        ],
...
let AuthService = class AuthService {
    constructor(userRepository, loginSessionRepository, jwtService) {
        this.userRepository = userRepository;
        this.loginSessionRepository = loginSessionRepository;
...
exports.AuthService = AuthService = tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, typeorm_1.InjectRepository)(src_1.User)),
    tslib_1.__param(1, (0, typeorm_1.InjectRepository)(src_1.LoginSession)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _a : Object, typeof (_b = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _b : Object, typeof (_c = typeof jwt_service_1.JwtService !== "undefined" && jwt_service_1.JwtService) === "function" ? _c : Object])
], AuthService);
...
const auth_service_1 = __webpack_require__(102);
const config_service_1 = __webpack_require__(6);
const authenticated_request_interface_1 = __webpack_require__(108);
const response_handler_service_1 = __webpack_require__(67);
const user_dto_1 = __webpack_require__(109);
...
const common_1 = __webpack_require__(1);
const passport_1 = __webpack_require__(101);
const passport_google_oauth20_1 = __webpack_require__(111);
const config_service_1 = __webpack_require__(6);
...
exports.DefaultUserService = DefaultUserService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof user_repository_1.UserRepositoryService !== "undefined" && user_repository_1.UserRepositoryService) === "function" ? _a : Object, typeof (_b = typeof permissionManager_repository_1.PermissionManagerService !== "undefined" && permissionManager_repository_1.PermissionManagerService) === "function" ? _b : Object])
], DefaultUserService);
...
const src_1 = __webpack_require__(69);
const response_handler_module_1 = __webpack_require__(66);
const department_controller_1 = __webpack_require__(115);
const department_service_1 = __webpack_require__(117);
...
const express_1 = __webpack_require__(91);
const response_handler_service_1 = __webpack_require__(67);
const department_dto_1 = __webpack_require__(116);
const department_service_1 = __webpack_require__(117);
const src_1 = __webpack_require__(94);
const permission_access_guard_1 = __webpack_require__(118);
const permission_access_decorator_1 = __webpack_require__(119);
const moduleConstants_1 = __webpack_require__(120);
const permissionManagerConstants_1 = __webpack_require__(20);
...
const src_1 = __webpack_require__(69);
const response_handler_module_1 = __webpack_require__(66);
const module_management_controller_1 = __webpack_require__(122);
const module_management_service_1 = __webpack_require__(124);
...
const express_1 = __webpack_require__(91);
const response_handler_service_1 = __webpack_require__(67);
const module_management_dto_1 = __webpack_require__(123);
const module_management_service_1 = __webpack_require__(124);
const src_1 = __webpack_require__(94);
const permission_access_guard_1 = __webpack_require__(118);
const permission_access_decorator_1 = __webpack_require__(119);
...
const service_master_entity_1 = __webpack_require__(33);
const response_handler_module_1 = __webpack_require__(66);
const lead_controller_1 = __webpack_require__(126);
const lead_service_1 = __webpack_require__(129);
...
const express_1 = __webpack_require__(91);
const response_handler_service_1 = __webpack_require__(67);
const lead_dto_1 = __webpack_require__(127);
const lead_service_1 = __webpack_require__(129);
const src_1 = __webpack_require__(94);
const permission_access_guard_1 = __webpack_require__(118);
const permission_access_decorator_1 = __webpack_require__(119);
...
const tslib_1 = __webpack_require__(4);
const class_transformer_1 = __webpack_require__(128);
const class_validator_1 = __webpack_require__(17);
const salesConstants_1 = __webpack_require__(42);
...
const src_1 = __webpack_require__(69);
const systemModule_entity_1 = __webpack_require__(22);
const user_management_controller_1 = __webpack_require__(131);
const user_management_service_1 = __webpack_require__(132);
const user_repository_1 = __webpack_require__(76);
...
exports.UserManagementModule = UserManagementModule = tslib_1.__decorate([
    (0, common_1.Module)({
        ...
        providers: [user_management_service_1.UserManagementService, user_repository_1.UserRepositoryService],
    })
...
const userContants_1 = __webpack_require__(16);
const permissionManagerConstants_1 = __webpack_require__(20);
const user_management_dto_1 = __webpack_require__(133);
...
exports.UserManagementService = UserManagementService = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _a : Object, typeof (_b = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _b : Object, typeof (_c = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _c : Object, typeof (_d = typeof typeorm_2.Repository !== "undefined" && typeorm_2.Repository) === "function" ? _d : Object, typeof (_e = typeof user_repository_1.UserRepositoryService !== "undefined" && user_repository_1.UserRepositoryService) === "function" ? _e : Object])
...
let TeamService = class TeamService {
    ...
    async createTeam(payload) {
        try {
            // Validate Department
            const department = await this.departmentRepository.findOne({ where: { id: payload.departmentId } });
            if (!department) {
                throw new common_1.NotFoundException('Department not found');
            }
            // Validate Team Lead if provided
            if (payload.teamLeadId) {
                const lead = await this.userRepository.findOne({ where: { id: payload.teamLeadId } });
                if (!lead) {
