    ...
    async getDashboardCounts() {
        ...
        const totalClient = await this.leadRepo.createQueryBuilder('lead')
            ...
            const subQuery = qb.subQuery()
                .select('1')
                .from(lead_service_entity_1.LeadService, 'ls')
        ...
        const serviceListCount = await this.leadServiceRepo.createQueryBuilder('ls')
            ...
            .where('ls.status != :droppedStatus', { droppedStatus: lead_service_entity_1.SERVICE_STATUS.DROPPED })
            .andWhere(qb => {
            const subQuery = qb.subQuery()
                .select('1')
                .from(proposal_entity_1.Proposal, 'p')
