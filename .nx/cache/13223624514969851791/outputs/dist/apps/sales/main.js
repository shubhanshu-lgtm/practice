...
const invoice_module_1 = __webpack_require__(130);
...
let DashboardService = class DashboardService {
    ...
    async getDashboardCounts() {
        ...
        const serviceListItems = await this.leadServiceRepo.createQueryBuilder('ls')
            ...
            .leftJoin(proposal_entity_1.Proposal, 'p', 'p.id = pi.proposalId AND p.status != :droppedProposalStatus', { droppedProposalStatus: proposal_entity_1.PROPOSAL_STATUS.DROPPED })
            .where('lead.isActive = :isActive', { isActive: true })
        ...
        const proposalListCount = await this.proposalRepo.count({
            where: {
                status: (0, typeorm_2.Not)((0, typeorm_2.In)([proposal_entity_1.PROPOSAL_STATUS.DROPPED])),
                lead: { isActive: true }
            }
        });
        const pendingClients = serviceListItems.length + proposalListCount;
        // 4. Drop Leads = Count of inactive leads or leads with dropped components (Matches Dropped List API)
        const dropClientsCount = await this.leadRepo.createQueryBuilder('lead')
            ...
            qb.where('lead.isActive = :isActiveFalse', { isActiveFalse: false })
                .orWhere('lead.status = :leadLostStatus', { leadLostStatus: salesConstants_1.LEAD_STATUS.LOST })
...
const common_1 = __webpack_require__(2);
const typeorm_1 = __webpack_require__(11);
const invoice_controller_1 = __webpack_require__(131);
const invoice_service_1 = __webpack_require__(132);
const invoice_report_service_1 = __webpack_require__(133);
const invoice_entity_1 = __webpack_require__(68);
const invoice_item_entity_1 = __webpack_require__(69);
const payment_record_entity_1 = __webpack_require__(70);
const proposal_acceptance_entity_1 = __webpack_require__(66);
...
const response_handler_service_1 = __webpack_require__(90);
const authMiddleware_guard_1 = __webpack_require__(110);
const invoice_dto_1 = __webpack_require__(134);
const salesConstants_1 = __webpack_require__(48);
